...
public class SPLMatrix extends Matrix {
    ...
    public static SPLMatrix augmentABMatrix(Matrix A, Matrix B){
        // return augmented matrix from coefficient Matrix A and result matrix B
    ...
    public SolutionType[] AugmentedSols(){
        // return array of SolutionType containing solutions for the Reduced Echelon matrix
    ...
    public SolutionType[] solveFromScratch(){
        // Procedure to get solution from SPL Matrix using Gauss Jordan Elimination Method
        reduceToEchelon();
    ...
    public String GaussSolve(){
        // Procedure to get solution from SPL Matrix using Gauss Elimination Method
        reduceToEchelon();
    ...
    public String inverseMatrixSolve(){
        // Procedure to get solution from SPL Matrix using Inverse Matrix
    ...
    public String cramerSolve(){
        // Procedure to get solution from SPL Matrix using Cramer's Rule
        SquareMatrix A = getMatrixA();
        Matrix B = getMatrixB();
    ...
    public SquareMatrix getMatrixA(){
        // Procedure to get A Matrix from an augmented Matrix
